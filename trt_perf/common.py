...
def find_sample_data(description="Runs a TensorRT Python sample", subfolder="", find_files=[]):
    ...
    parser.add_argument("-model", "--model_name", help="model name.")
    parser.add_argument("-precision", "--trt_precision", help="precision.")

    args, unknown_args = parser.parse_known_args()

    # If data directory is not specified, use the default.
    data_root = args.datadir if args.datadir else kDEFAULT_DATA_ROOT
    model = args.model_name if args.model_name else kDEFAULT_DATA_ROOT
    precision = args.trt_precision if args.trt_precision else kDEFAULT_DATA_ROOT
